        ...
        public async Task<List<Producto>> ObtenerTodosAsync()
{
            ...
            while (await reader.ReadAsync())
            {
                lista.Add(new Producto
                {
                    ...
                    Abreviatura = reader.IsDBNull(reader.GetOrdinal("abreviatura"))
                        ? null
                        : reader.GetString(reader.GetOrdinal("abreviatura")),

                    UnidadMedidaId = reader.IsDBNull(reader.GetOrdinal("unidad_medida_id"))
                        ? null
                        : reader.GetInt32(reader.GetOrdinal("unidad_medida_id")),

                    UnidadMedida = new UnidadMedida
                    {
                        Descripcion = reader.IsDBNull(reader.GetOrdinal("unidad_medida"))
                            ? string.Empty
                            : reader.GetString(reader.GetOrdinal("unidad_medida"))
                    },

                    TipoProductoId = reader.IsDBNull(reader.GetOrdinal("tipo_producto_id"))
                        ? null
                        : reader.GetInt32(reader.GetOrdinal("tipo_producto_id")),

                    PrecioUnitario = reader.IsDBNull(reader.GetOrdinal("precio_unitario"))
                        ? 0.00m
                    ...
                    NivelId = reader.IsDBNull(reader.GetOrdinal("nivel_id"))
                        ? null
                        : reader.GetInt32(reader.GetOrdinal("nivel_id")),

                    GradoId = reader.IsDBNull(reader.GetOrdinal("grado_id"))
                        ? null
                        : reader.GetInt32(reader.GetOrdinal("grado_id")),

                    CursoId = reader.IsDBNull(reader.GetOrdinal("curso_id"))
                        ? null
                        : reader.GetInt32(reader.GetOrdinal("curso_id")),

                    TituloCursoId = reader.IsDBNull(reader.GetOrdinal("titulo_curso_id"))
                        ? null
                        : reader.GetInt32(reader.GetOrdinal("titulo_curso_id")),

                    AfectacionIgvId = reader.IsDBNull(reader.GetOrdinal("afectacion_igv_id"))
                        ? null
                        : reader.GetInt32(reader.GetOrdinal("afectacion_igv_id")),

                    afectacion = new AfectacionIgv
                    {
                        Nombre = reader.IsDBNull(reader.GetOrdinal("afectacion_igv"))
                            ? string.Empty
                            : reader.GetString(reader.GetOrdinal("afectacion_igv"))
                    },
                    ...
                    Estado = new Estado
                    {
                        Nombre = reader.IsDBNull(reader.GetOrdinal("estado"))
                            ? string.Empty
        ...
        public async Task<List<UnidadMedida>> ObtenerUnidadesMedidaAsync()
        {
            ...
            using var cmd = conn.CreateCommand();
            cmd.CommandText = "SELECT id, descripcion FROM unidad_medida WHERE estado_id = 1 ORDER BY descripcion";
        ...
        public async Task<List<TipoProducto>> ObtenerTiposProductoAsync()
        {
            ...
            using var cmd = conn.CreateCommand();
            cmd.CommandText = "SELECT id, nombre FROM tipo_producto ORDER BY nombre";
        ...
        public async Task<List<Nivel>> ObtenerNivelesAsync()
        {
            ...
            using var cmd = conn.CreateCommand();
            cmd.CommandText = "SELECT id, nombre FROM niveles ORDER BY nombre";
        ...
        public async Task<List<Grado>> ObtenerGradosAsync(int nivelId)
        {
            ...
            using var cmd = conn.CreateCommand();
            cmd.CommandText = "SELECT id, nombre FROM grados WHERE nivel_id = @NivelId ORDER BY nombre";
        ...
        public async Task<List<Curso>> ObtenerCursosAsync(int nivelId)
        {
            ...
            using var cmd = conn.CreateCommand();
            cmd.CommandText = "SELECT id, nombre FROM curso WHERE nivel_id = @NivelId ORDER BY nombre";
        ...
        public async Task<List<TituloCurso>> ObtenerTitulosAsync()
        {
            ...
            using var cmd = conn.CreateCommand();
            cmd.CommandText = "SELECT id, nombre FROM titulo_curso WHERE estado_id = 1 ORDER BY nombre";
            using var reader = await ((DbCommand)cmd).ExecuteReaderAsync();
        ...
        public async Task<List<AfectacionIgv>> ObtenerAfectacionesIgvAsync()
        {
            ...
            using var cmd = conn.CreateCommand();
            cmd.CommandText = "SELECT id, nombre FROM afectacion_igv ORDER BY nombre";

            using var reader = await ((DbCommand)cmd).ExecuteReaderAsync();

            while (await reader.ReadAsync())
            {
                lista.Add(new AfectacionIgv
                {
                    Id = reader.GetInt32(0),
                    Nombre = reader.GetString(1)
                });
            ...
            return await Task.Run(() =>
            {
                ...
                while (reader.Read())
                {
                    lista.Add(new Producto
                    {
                        ...
                        Abreviatura = reader["abreviatura"] == DBNull.Value
                            ? null
